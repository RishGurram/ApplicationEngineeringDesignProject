...
public class AdminStock extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblStock.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Plasma Center", "Blood Group", "Quantity Units", "object"
            }
        ) {
        ...
        if (tblStock.getColumnModel().getColumnCount() > 0) {
            ...
            tblStock.getColumnModel().getColumn(3).setPreferredWidth(0);
            tblStock.getColumnModel().getColumn(3).setMaxWidth(0);
        }

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(30, 110, 450, 300);
